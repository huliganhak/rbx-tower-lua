...
-------------------------------------------------------
local detailBox = createTextBox(frame, nil, UDim2.new(0.1, 0, 0.05, 0), UDim2.new(0.5, 0, 0.1, 0), false)
detailBox.Text = "สถานะ..."
detailBox.BackgroundColor3 = Color3.fromRGB(40, 40, 40)

local roundsBox = createTextBox(frame, "จำนวนรอบ", UDim2.new(0.1, 0, 0.10, 0), UDim2.new(0.8, 0, 0.10, 0))
...
local hatchButton = createButton(frame, "Hatch", UDim2.new(0.1, 0, 0.45, 0), UDim2.new(0.8, 0, 0.15, 0))
