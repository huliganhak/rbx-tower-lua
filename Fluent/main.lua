...
-- Begin Module: Acrylic.AcrylicBlur
local ['Acrylic.AcrylicBlur'] = (function()
...
-- Begin Module: Acrylic.AcrylicPaint
local ['Acrylic.AcrylicPaint'] = (function()
local Creator = require(script.Parent.Parent.Creator)
...
-- Begin Module: Acrylic.CreateAcrylic
local ['Acrylic.CreateAcrylic'] = (function()
...
-- Begin Module: Acrylic.Utils
local ['Acrylic.Utils'] = (function()
...
-- Begin Module: Acrylic.init
local ['Acrylic.init'] = (function()
local Acrylic = {
...
-- Begin Module: Components.Assets
local ['Components.Assets'] = (function()
return {
...
-- Begin Module: Components.Button
local ['Components.Button'] = (function()
local Root = script.Parent.Parent
local Flipper = require(Root.Packages.Flipper)
local Creator = require(Root.Creator)
local New = Creator.New
...
-- Begin Module: Components.Dialog
local ['Components.Dialog'] = (function()
local UserInputService = game:GetService("UserInputService")
...
-- Begin Module: Components.Element
local ['Components.Element'] = (function()
local Root = script.Parent.Parent
local Flipper = require(Root.Packages.Flipper)
local Creator = require(Root.Creator)
local New = Creator.New
...
-- Begin Module: Components.Notification
local ['Components.Notification'] = (function()
local Root = script.Parent.Parent
local Flipper = require(Root.Packages.Flipper)
local Creator = require(Root.Creator)
local Acrylic = require(Root.Acrylic)
...
-- Begin Module: Components.Section
local ['Components.Section'] = (function()
local Root = script.Parent.Parent
local Creator = require(Root.Creator)
...
-- Begin Module: Components.Tab
local ['Components.Tab'] = (function()
local Root = script.Parent.Parent
local Flipper = require(Root.Packages.Flipper)
local Creator = require(Root.Creator)
...
-- Begin Module: Components.Textbox
local ['Components.Textbox'] = (function()
...
-- Begin Module: Components.TitleBar
local ['Components.TitleBar'] = (function()
local Root = script.Parent.Parent
...
-- Begin Module: Components.Window
local ['Components.Window'] = (function()
...
-- Begin Module: Elements.Button
local ['Elements.Button'] = (function()
local Root = script.Parent.Parent
local Creator = require(Root.Creator)
...
-- Begin Module: Elements.Colorpicker
local ['Elements.Colorpicker'] = (function()
local UserInputService = game:GetService("UserInputService")
...
-- Begin Module: Elements.Dropdown
local ['Elements.Dropdown'] = (function()
local TweenService = game:GetService("TweenService")
local UserInputService = game:GetService("UserInputService")
local Mouse = game:GetService("Players").LocalPlayer:GetMouse()
local Camera = game:GetService("Workspace").CurrentCamera
...
-- Begin Module: Elements.Input
local ['Elements.Input'] = (function()
local Root = script.Parent.Parent
local Creator = require(Root.Creator)
...
-- Begin Module: Elements.Keybind
local ['Elements.Keybind'] = (function()
local UserInputService = game:GetService("UserInputService")
...
-- Begin Module: Elements.Paragraph
local ['Elements.Paragraph'] = (function()
local Root = script.Parent.Parent
local Components = Root.Components
local Flipper = require(Root.Packages.Flipper)
local Creator = require(Root.Creator)
...
-- Begin Module: Elements.Slider
local ['Elements.Slider'] = (function()
local UserInputService = game:GetService("UserInputService")
local Root = script.Parent.Parent
local Creator = require(Root.Creator)
...
-- Begin Module: Elements.Toggle
local ['Elements.Toggle'] = (function()
local TweenService = game:GetService("TweenService")
local Root = script.Parent.Parent
local Creator = require(Root.Creator)
...
-- Begin Module: Elements.init
local ['Elements.init'] = (function()
local Elements = {}
...
-- Begin Module: Packages.Flipper.BaseMotor
local ['Packages.Flipper.BaseMotor'] = (function()
local RunService = game:GetService("RunService")
...
-- Begin Module: Packages.Flipper.BaseMotor.spec
local ['Packages.Flipper.BaseMotor.spec'] = (function()
return function()
	local RunService = game:GetService("RunService")
...
-- Begin Module: Packages.Flipper.GroupMotor
local ['Packages.Flipper.GroupMotor'] = (function()
local BaseMotor = require(script.Parent.BaseMotor)
...
-- Begin Module: Packages.Flipper.GroupMotor.spec
local ['Packages.Flipper.GroupMotor.spec'] = (function()
return function()
...
-- Begin Module: Packages.Flipper.Instant
local ['Packages.Flipper.Instant'] = (function()
local Instant = {}
...
-- Begin Module: Packages.Flipper.Instant.spec
local ['Packages.Flipper.Instant.spec'] = (function()
return function()
	local Instant = require(script.Parent.Instant)
...
-- Begin Module: Packages.Flipper.Linear
local ['Packages.Flipper.Linear'] = (function()
local Linear = {}
...
-- Begin Module: Packages.Flipper.Linear.spec
local ['Packages.Flipper.Linear.spec'] = (function()
return function()
	local SingleMotor = require(script.Parent.SingleMotor)
...
-- Begin Module: Packages.Flipper.Signal
local ['Packages.Flipper.Signal'] = (function()
local Connection = {}
...
-- Begin Module: Packages.Flipper.Signal.spec
local ['Packages.Flipper.Signal.spec'] = (function()
return function()
	local Signal = require(script.Parent.Signal)
...
-- Begin Module: Packages.Flipper.SingleMotor
local ['Packages.Flipper.SingleMotor'] = (function()
local BaseMotor = require(script.Parent.BaseMotor)
...
-- Begin Module: Packages.Flipper.SingleMotor.spec
local ['Packages.Flipper.SingleMotor.spec'] = (function()
return function()
	local SingleMotor = require(script.Parent.SingleMotor)
	local Instant = require(script.Parent.Instant)
...
-- Begin Module: Packages.Flipper.Spring
local ['Packages.Flipper.Spring'] = (function()
...
-- Begin Module: Packages.Flipper.Spring.spec
local ['Packages.Flipper.Spring.spec'] = (function()
return function()
	local SingleMotor = require(script.Parent.SingleMotor)
	local Spring = require(script.Parent.Spring)
...
-- Begin Module: Packages.Flipper.init
local ['Packages.Flipper.init'] = (function()
local Flipper = {
...
-- Begin Module: Packages.Flipper.isMotor
local ['Packages.Flipper.isMotor'] = (function()
...
-- Begin Module: Packages.Flipper.isMotor.spec
local ['Packages.Flipper.isMotor.spec'] = (function()
return function()
	local isMotor = require(script.Parent.isMotor)
...
-- Begin Module: Themes.Amethyst
local ['Themes.Amethyst'] = (function()
return {
	Name = "Amethyst",
...
-- Begin Module: Themes.Aqua
local ['Themes.Aqua'] = (function()
return {
	Name = "Aqua",
...
-- Begin Module: Themes.Dark
local ['Themes.Dark'] = (function()
return {
	Name = "Dark",
...
-- Begin Module: Themes.Darker
local ['Themes.Darker'] = (function()
return {
	Name = "Darker",
...
-- Begin Module: Themes.Light
local ['Themes.Light'] = (function()
return {
	Name = "Light",
...
-- Begin Module: Themes.Rose
local ['Themes.Rose'] = (function()
return {
	Name = "Rose",
...
-- Begin Module: Themes.init
local ['Themes.init'] = (function()
local Themes = {
	Names = {
		"Dark",
		"Darker",
